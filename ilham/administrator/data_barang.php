...
<div class="jumbotron" style="padding: 0px; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.3)">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
<h3>DATA BARANG</h3>
		...
		<div class="modal-content">
			...
			<form action="proses_simpan_barang.php" method="post">
				<div class="modal-body">				
					<div class="form-group">
						<label>Nama Produk</label>
						<input type="text" name="NamaProduk" class="form-control" placeholder = 'Nama Produk' autofocus>
					</div>
					<div class="form-group">
						<label>Harga Produk</label>
						<input type="number" name="Harga" class="form-control" placeholder = 'Harga' autofocus>
					</div>
					<div class="form-group">
						<h6><p>Stok Produk</p></h6>
						<input type="number" name="Stok" class="form-control" placeholder = 'Stok' autofocus>
					</div>
				</div>
				<div class="modal-footer">
